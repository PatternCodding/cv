        ...
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                    ...
                    <p class="card-text font-size-14 text-black-50 py-1">Note we only accept dollar here, other currencies ought to be converted by the buyer before proceeding, if your product is not found on here click oon Go <strong>Go somewhere</strong>.</p>
